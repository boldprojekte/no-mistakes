...
func TestRenderApprovalActions_FormatWithSeparator(t *testing.T) {
	out := stripANSI(renderApprovalActions(true, true, false, 5, 5, false, true, true, false, false, false))
...
func TestRenderApprovalActions_NoSelectionActions(t *testing.T) {
	out := stripANSI(renderApprovalActions(false, true, false, 5, 5, false, true, true, false, false, false))
...
func TestRenderPipelineView_HidesFixActionWhenDisabled(t *testing.T) {
	...
	out := stripANSI(renderActionBar(run.Steps, true, false, false, 0, 5, false, true, true, false, false, false))
